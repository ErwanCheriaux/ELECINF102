...
#-----------------------------------------------------
# Mdified by T.Graba ENST/GET
# Contain all pin definitions and FPGA/Board specifications
# version 1.0 functionnal
# TODO optimise compilation steps
...
# set_global_assignment -name VERILOG_FILE "../src/______.v"

set_global_assignment -name SYSTEMVERILOG_FILE $opts(src_dir)/DE1_SoC.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(src_dir)/gene_clk.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(src_dir)/gene_reset.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(src_dir)/nanoprocesseur.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(src_dir)/ram.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(sv_dir)/ctr.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(sv_dir)/pc.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(sv_dir)/alu.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(sv_dir)/codec.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(sv_dir)/seven_seg.sv
set_global_assignment -name SYSTEMVERILOG_FILE $opts(sv_dir)/codec_ctrl.sv
...
# 
#  set_instance_assignment -name PARTITION_HIERARCHY db/p7SEG0 -to "seg_dec:DEC_7SEG0" -section_id p7SEG0
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id p7SEG0
#
#  set_instance_assignment -name PARTITION_HIERARCHY db/p7SEG1 -to "seg_dec:DEC_7SEG1" -section_id p7SEG1
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id p7SEG1
#
#  set_instance_assignment -name PARTITION_HIERARCHY db/p7SEG4 -to "seg_dec:DEC_7SEG4" -section_id p7SEG4
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id p7SEG4
# 
#  set_instance_assignment -name PARTITION_HIERARCHY db/p7SEG7 -to "seg_dec:DEC_7SEG7" -section_id p7SEG7
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id p7SEG7
#
#  set_instance_assignment -name PARTITION_HIERARCHY db/p7SEG6 -to "seg_dec:DEC_7SEG6" -section_id p7SEG6
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id p7SEG6
#
#  set_instance_assignment -name PARTITION_HIERARCHY db/pCLK_div -to "div_horloge:div_H" -section_id pCLK_div
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id pCLK_div
# 
#  set_instance_assignment -name PARTITION_HIERARCHY db/pLCD_ENST -to "LCD_ENST:u5" -section_id pLCD_ENST
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id pLCD_ENST
# 
#  set_instance_assignment -name PARTITION_HIERARCHY db/pRST_D -to "Reset_Delay:r0" -section_id pRST_D
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id pRST_D
# 
#  set_instance_assignment -name PARTITION_HIERARCHY db/pRAM -to "memoire:MaRam" -section_id pCODEUR
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id pRAM
# 
#  set_instance_assignment -name PARTITION_HIERARCHY db/pPROC -to "nanoprocesseur:MonProc" -section_id pDECODEUR
#  set_global_assignment -name PARTITION_NETLIST_TYPE POST_FIT -section_id pPROC
#
#  ###############################################################################################
###############################################################################################
